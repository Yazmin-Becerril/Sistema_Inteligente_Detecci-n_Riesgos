...
Razonamiento (Inteligencia del sistema)
...
El usuario abre la interfaz web y conecta el Arduino.
La cámara web captura imágenes del entorno.
El modelo de Teachable Machine clasifica el objeto observado.
La lógica del sistema evalúa la clase y el nivel de confianza.
Se envía un comando al Arduino según el nivel de riesgo.
El Arduino activa el LED correspondiente como alerta visual.
